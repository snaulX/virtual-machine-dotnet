...
{
    public class DivExpression : VMExpression
    {
        public Value ParseExpression(params Value[] args)
        {
            ...
            {
                VirtualMachine.ThrowVMException($"Value with type {type.strtype} not support div", VirtualMachine.position, ExceptionType.TypeNotSupportedException);
